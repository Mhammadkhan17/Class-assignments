...
export default function Home() {
  ...
  <div className="max-w-3xl mx-auto text-center px-4">
    ...
    <p className="text-gray-700 mb-4">
      Artificial Intelligence is transforming industries and shaping the future. Whether you're a student, professional, or lifelong learner, mastering AI can open doors to exciting opportunities and empower you to create impactful solutions.
    </p>
    <ul className="list-disc list-inside text-left mb-6">
      <li><strong>Enhance Your Career:</strong> AI skills are highly sought after in today's job market.</li>
    ...
    <p className="text-gray-700 mb-6">
      With abundant resources and communities available, there's never been a better time to dive into AI. Embrace the future, expand your knowledge, and be a part of the technological revolution.
    </p>
